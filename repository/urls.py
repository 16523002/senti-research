...
urlpatterns = [
    ...
    path('workspace/research-view/', views.researchview, name='researchview'), #TABLE:  this is the page to see the details of certain research project
    ...
    path('workspace/respondent-view/', views.respondentview, name='respondentview'), #TABLE:  this is the page to see the details of certain respondent
